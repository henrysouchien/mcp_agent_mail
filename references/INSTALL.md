...
> **Legacy/migration guide:** The installer, static bearer example, doctor,
> archive backup, and Docker snippets below describe the historical deployment.
> They are not sufficient for `RUNTIME_PROFILE=core`. For core service-manager,
> owner/pepper secret, durable database/blob, managed registration, and rollout
> requirements, use [CORE-DEPLOYMENT.md](CORE-DEPLOYMENT.md). Do not start a core
> service from these snippets.
...
### Run Diagnostics (legacy/migration only)
