...
def _setup_fts(connection: Any) -> None:
    ...
    for migration_sql in [
        ...
        "ALTER TABLE runtime_bindings ADD COLUMN process_id INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE runtime_bindings ADD COLUMN host_boot_id VARCHAR(255) NOT NULL DEFAULT ''",
        ...
        "ALTER TABLE continuation_receipts ADD COLUMN process_id INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE continuation_receipts ADD COLUMN host_boot_id VARCHAR(255) NOT NULL DEFAULT ''",
